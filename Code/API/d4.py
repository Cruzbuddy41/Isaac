...
def takeImage():
    ...
    # --- NECESSARY TIMING FIX ---
    # Only allow the detection code to process frames when the robot is actively SEARCHING
    if direction == "SEARCHING":
        ...
        # Keep resetting the timer back to 6 while we are safely driving on lines
        waittimer = 6
...
# Cleaned up duplicate movement function; kept the one handling "ERROR" states
